...
--\Libraries\
local Notification = loadstring(game:HttpGet("https://raw.githubusercontent.com/Knowscript/script/main/NotificationLib.lua"))()
function err(txt)
...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Knowscript/main/main/hub-ui.lua"))()
library.theme = {
    fontsize = 15,
    font = Enum.Font.Code,
...
if not CarCollection or not rF or not rE then return err("Wrong game") else Notification.Notify("Car Crushers 2", "made by know.pimlisy", Players:GetUserThumbnailAsync(LocalPlayer.UserId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size420x420)); wait(1) end -- check
    ...
    local miscTab = window:CreateTab("Misc")
        ...
        local serverSector = miscTab:CreateSector("Servers", 'left')
            ...
            smallest_button = serverSector:AddButton("Join Smallest Server", function()
                if syn then 
                    coroutine.resume(coroutine.create(function() loadstring(game:HttpGet("https://raw.githubusercontent.com/Knowscript/script/main/JoinLowestPlayer.lua"))()  end))
                else
        ...
        local discSector = miscTab:CreateSector("Discord", 'left')
            ...
            copydisc_button = discSector:AddButton("Copy to Clipboard", function() if setclipboard then setclipboard('https://discord.gg/uB8KYHQ7yw') else print("uB8KYHQ7yw") end end)
